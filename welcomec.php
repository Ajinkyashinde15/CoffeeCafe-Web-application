...
<div role="main" class="ui-content">
 <div class="col-md-3"></div>
	...
	Update your Profile
          <form id="contact" method="post" action="ureg.php"  role="form">
          <div class="row">
            <div class="col-md-12 form-group">
                <input class="form-control" id="name" name="name" placeholder="Name" value="<?php echo $fn;?>" type="text" required />
            </div>
            <div class="col-md-12 form-group">
              <input class="form-control" id="email" name="email" placeholder="Email" value="<?php echo $email;?>" type="email" required />
            </div>
			 <div class="col-md-12 form-group">
              <input class="form-control" id="phone" name="phone" pattern="\d{10}" value="<?php echo $pno;?>" placeholder="Phone Number(9999999999)" type="tel" required />
            </div>
               <div class="col-md-12 form-group">
                   <input class="form-control" id="name" name="uname" readonly="" value="<?php echo $un;?>" placeholder="Provide User Name" type="text" required />
            </div>
            <div class="col-md-12 form-group">
              <input class="form-control" id="email" value="<?php echo $pass;?>" name="password" placeholder="Provide Password" type="password" required />
            </div>
			 <div class="col-md-12 form-group">
              <textarea class="form-control" id="message" name="address" placeholder="Address" rows="5"><?php echo $add;?></textarea>             
              <button class="btn btn-lg pull-left" type="submit">Update Profile</button>
            </div>
          </div>
